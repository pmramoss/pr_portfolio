...
export default function Projects({content}: Props){
     return (
          <div id="projects" className={styles.projects}>
               ...
               <Container image={aluroni} name="Aluroni" descript={content.Projects_descript1} tag1="React" tag2="Sass" github="https://github.com/pmramoss/pr_aluroni" link="https://pr-aluroni.vercel.app/"/>
